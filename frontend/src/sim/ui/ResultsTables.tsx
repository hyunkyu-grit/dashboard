 ...
 * ("좌우 스크롤 하기 싫음", 2026-08-10)은 은퇴했다. 넘치는 폭은 보이는
 * 스크롤바가 받는다 [OWNER, 같은 날 2차 — "마우스로 잡아 끄는게 아니라
 * 좌우 스크롤이 가능하게 … 좌우의 범례는 열과 행 고정"]: 양축 스크롤러
 * (높이 캡)에 범례 사방 고정 — 테너 헤더 행 top · 날짜·구분 left ·
 * 합계~그날 손익 right. 먼저 만들었던 드래그 팬(useDragScroll)은 같은 날
 * 걷어냈다. 날짜는 MM-DD(연도·D+n 은 title) 그대로.
